...
function KeyValueManagement() {
  ...
  const clickAddHandler = () => {
    navigate("/key-value-management/new-key-value-management");
  };


  const clickEditHandler = (id) => {
    navigate(`/key-value-management/edit-key-value-management/${id}`);
  };
 ...
 */
  ...
  const dataTableData = {
    columns: [
    { Header: "Key", accessor: "test", width: "20%" },
      { Header: "Value", accessor: "name", width: "20%" },
      {
        Header: "Created By",
        //accessor: "owner",
        width: "20%",
