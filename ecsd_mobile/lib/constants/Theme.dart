...
class ArgonColors {
  ...
  static const Color primary = Color.fromRGBO(8, 33, 171, 1);

  static const Color secondary = Color.fromRGBO(73, 98, 115, 1);
  ...
  static const Color header = Color.fromRGBO(8, 33, 171, 1);
  ...
  static const Color text = Color.fromRGBO(49, 49, 220, 1);
}
